...
tmp = setNames(tmp, c("0.1", "0.1", "0.1", 
                   "0.2", "0.2", "0.2", 
                   "5", "5", "5", 
                   "1", "1", "1", 
                   "24", "24", "24", 
...
filename = "~/Data/Expression/Proteomics/Garcia/processed/processed_garcia.xlsx"
write.xlsx(final_df, filename)
```
