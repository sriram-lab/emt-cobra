...
# 6. Get differentially expressed CERES score by comparing metastatic / primary site using limma-voom
...
# 7. Get gene list that are universally lethal across all cell lines
...
# 8. Get differentially expressed genes for A549 from CERES score
...
# 9. Get differentially expressed genes across all NSCLC cell lines
```{r}
