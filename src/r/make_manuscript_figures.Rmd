...
bardata = top50[, 4]
expt_data = top50[, 5]
top50$name = paste0(top50$`Reaction Name`, 
                    ', ',
...
kegg_subsys = rowAnnotation(Pathway=pathway,
                            col=list(EMT=c("NA"="#484041", 
                                           "Taurine and hypotaurine metabolism"="#434371",
                                           "Galactose metabolism"="#79AEA3",
                                           "Glutamate metabolism"="#70EE9C",
                                           "R Group Synthesis"="#B5F44A",
                                           "Fatty acid activation"="#004777",
                                           "Pyrimidine Catabolism"="#A30000",
                                           "Nucleotides"="#FF7700",
                                           "Citric Acid Cycle"="#EFD28D",
                                           "Propanoate Metabolism"="#00AFB5",
                                           "Pyruvate Metabolism"="#FFC800",
                                           "Glycolysis/Gluconeogenesis"="#1E212B",
                                           "Transport, Mitochondrial"="#AF3E4D",
                                           "Pentose Phosphate Pathway"="#56E39F",
                                           "Transport, Extracellular"="#2A1F2D",
                                           "Alanine and Aspartate Metabolism"="#B81365",
                                           "Fatty acid elongation"="#055864",
                                           "Methionine Metabolism"="#B9BAA3",
                                           "Carnitine shuttle"="#484041")
                                     )
                            )
```
...
rownames(final_data) = top50$name
ht = Heatmap(row_names_side="left",
             final_data, 
             bottom_annotation=all_col,
...
#### i. Reformat the data
```{r}
idx = (pathway == "Glycolysis/Gluconeogenesis")
idx[is.na(idx)] = FALSE
glycolysis_data = reformat_data[idx, ]
glycolysis_labels = top50[idx, 2]
bardata = top50[idx, 4]
...
#       legend_title_gp = gpar(fontfamily = "TT Arial"),
#       legend_labels_gp = gpar(fontfamily = "TT Arial"))
final_data = as.matrix(glycolysis_data)
