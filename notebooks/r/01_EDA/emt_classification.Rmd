...
We'll now construct the ROC object.
```{r, fig.height=5, fig.width=5}
rocobj = roc(as.numeric(encoding_to_save$PM_State), as.numeric(encoding_to_save$EM_State))
auc = round(auc(as.numeric(encoding_to_save$PM_State),as.numeric(encoding_to_save$EM_State)),4)

ggroc(rocobj, colour = "red", linetype = 1, size = 1) + 
  theme_minimal() + 
  ggtitle(paste0("Prim/Met versus Epi/Mes AUC = ", auc)) + 
