...
# Top 50 Reactions
tmp = reshape2::melt(top50_ceres)
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Top 50 Reaction Knockout NSCLC CERES Score Distribution", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/top50_ko_nsclc.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
tmp = reshape2::melt(lowconf_ceres)
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Low Confidence Reaction Knockout NSCLC CERES Score Distribution", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15)+
  theme(axis.text.x = element_text(angle=90, 
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/lowconf_ko_nsclc.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Top 50 NSCLC CERES Score Distribution", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15)+
  theme(axis.text.x = element_text(angle=90, 
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/top50_flux_nsclc.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
tmp = reshape2::melt(glycolysis_ceres)
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Glycolysis NSCLC CERES Score Distribution", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15)+
  theme(axis.text.x = element_text(angle=90, 
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/glycolysis_flux_nsclc.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
tmp = reshape2::melt(ppp_ceres)
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Pentose Phosphate Pathway NSCLC CERES Score Distribution", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15)+
  theme(axis.text.x = element_text(angle=90, 
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/ppp_flux_nsclc.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
# Specific Reactions
tmp = reshape2::melt(specific_ceres)
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Specific Reactions NSCLC CERES Score Distribution", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15)+
  theme(axis.text.x = element_text(angle=90, 
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/specific_flux_nsclc.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
### iii. Visualize heatmap
```{r, fig.height=5, fig.width=10, dpi=100}
tmp = reshape2::melt(singlecell_ceres)
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Single-Cell KO NSCLC CERES Score Distribution", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15)+
  theme(axis.text.x = element_text(angle=90, 
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/singlecell_ko_nsclc.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Top 50 Reaction Knockout CERES Score Distribution (All Cell Lines)", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15, 
              alpha=0.025)+
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/top50_ko_all.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Low Confidence Reaction Knockout CERES Score Distribution (All Cell Lines)", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15, 
              alpha=0.025)+
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/lowconf_ko_all.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Top 50 CERES Score Distribution (All Cell Lines)", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15, 
              alpha=0.025)+
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/top50_flux_all.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Glycolysis CERES Score Distribution (All Cell Lines)", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15, 
              alpha=0.025)+
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/glycolysis_flux_all.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Pentose Phosphate Pathway CERES Score Distribution (All Cell Lines)", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15, 
              alpha=0.025)+
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/ppp_flux_all.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Specific Reactions CERES Score Distribution (All Cell Lines)", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15, 
              alpha=0.025)+
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/specific_flux_all.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
...
ggplot(tmp, aes(x=Var1, y=value)) + 
  geom_boxplot() + 
  labs(title="Single-Cell KO CERES Score Distribution (All Cell Lines)", 
       x="Metabolic genes predicted by COBRA", 
       y="CERES Score") +
  geom_jitter(width=0.15, 
              alpha=0.025)+
...
ggsave(filename="D:/Analysis/EMT/figures/CRISPR/singlecell_ko_all.png",
       plot=last_plot(),
       device=png(),
       width=10, 
       height=5,
