...
```{r}
mnorm_ko = ko_data - colMeans(ko_data, na.rm=TRUE)
```
...
```{r}
tmp = ko_data
zko = (tmp - colMeans(tmp, na.rm=TRUE)) / apply(tmp, 2, sd, na.rm=TRUE)
```
...
```{r}
p = list()
p[[1]] = ggplot(merged_meanko, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[1]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
p[[2]] = ggplot(merged_meanko, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[2]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
p[[3]] = ggplot(merged_meanko, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[3]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
p[[4]] = ggplot(merged_meanko, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[4]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
p[[5]] = ggplot(merged_meanko, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[5]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
```{r}
p = list()
p[[1]] = ggplot(merged_meanflux, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[1]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
                     title=reaction_names[1], 
                     color="Flux") + 
                scale_colour_gradient2(low="black", mid = '#F29479', high='red', limits=c(0, max(tmp))) +
                theme(plot.title = element_text(size=26),
                            legend.text=element_text(size=22),
                            axis.title.x=element_text(size=22),
                            axis.title.y=element_text(size=22),
...
p[[2]] = ggplot(merged_meanflux, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[2]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
p[[3]] = ggplot(merged_meanflux, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[3]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
p[[4]] = ggplot(merged_meanflux, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[4]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
...
p[[5]] = ggplot(merged_meanflux, aes(x=UMAP_1, y=UMAP_2, color=tmp[, reactions_to_visualize[5]])) + 
                geom_point(size=5) +
                theme_minimal() +
                labs(x="UMAP 1", 
                     y="UMAP 2",
